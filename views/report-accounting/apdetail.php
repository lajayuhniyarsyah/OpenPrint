		...
		<div class="oe_form_sheetbg">
			<div class="oe_form_sheet oe_form_sheet_width">
				<div style="width:100%; float:left;">
					<div class="subjudul">AGED PAYABLES DETAIL</div>
					<a data-pjax="0" title="Reset AR Detail" href="<?php echo \yii\helpers\Url::to(['report-accounting/apdetail']); ?>" class="btn btn-default right" style="margin-right:10px;"><i class="glyphicon glyphicon-repeat"></i></a>
					<br/>
					<br/>
				</div>
