	...
	jQuery.each(lines,function(key,line){
		...
		if(currPage){
			if (cektable < HeightTable){
				var footer ='.$footer.';
				var footertotal = "<tr class=lineTable><td colspan=3></td><td colspan=3>TOTAL AMOUNT</td><td align=right>'.app\components\NumericLib::indoStyle($subtotal,2,',','.').'</td></tr><tr class=lineTable><td colspan=3></td><td colspan=3>Discount</td><td align=right>'.app\components\NumericLib::indoStyle($diskon,2,',','.').'</td></tr class=lineTable><tr><td colspan=3></td><td colspan=3>PPN 10%</td><td align=right>'.app\components\NumericLib::indoStyle($model->amount_tax,2,',','.').'</td></tr><tr class=lineTable><td colspan=3></td><td colspan=3>GRAND TOTAL</td><td align=right>'.app\components\NumericLib::indoStyle(round($model->amount_untaxed+$model->amount_tax-$diskon),2,',','.').'</td></tr>";
				...
				var footer ='.$footer.';
				var footertotal = "<tr class=lineTable><td colspan=3></td><td colspan=3>TOTAL AMOUNT</td><td align=right>'.app\components\NumericLib::indoStyle(round($subtotal),2,',','.').'</td></tr><tr class=lineTable><td colspan=3></td><td colspan=3>Discount</td><td align=right>'.app\components\NumericLib::indoStyle($diskon,2,',','.').'</td></tr class=lineTable><tr><td colspan=3></td><td colspan=3>PPN 10%</td><td align=right>'.app\components\NumericLib::indoStyle($model->amount_tax,2,',','.').'</td></tr><tr class=lineTable><td colspan=3></td><td colspan=3>GRAND TOTAL</td><td align=right>'.app\components\NumericLib::indoStyle(round($model->amount_untaxed+$model->amount_tax-$diskon),2,',','.').'</td></tr>";
				var res1 = "<tr><th width=30px height=25px>No.</th><th width=265px>DESCRIPTION</th><th width=89px>PART NO</th><th width=60px>QTY</th><th width=50px>UNIT</th><th width=80px>HARGA<br/>'.$pricelist.'</th><th width=107px>TOTAL<br/>'.$pricelist.'</th></tr>";
				var res = "<tr><td style=\"width:30px; height:"+SetHeight+"px;  text-align:center;\"></td><td style=\"width:265px; text-align:center;\"></td><td style=\"width:89px; text-align:center;\"><div class=\"leftdata\"></div><div class=\"rightdata\"></div></td><td style=\"width:60px; text-align:right;\"><div class=\"leftdata\"></div><div class=\"rightdata\"></div></td><td style=\"width:50px; text-align:center;\"><div class=\"leftdata\"></div><div class=\"rightdata\"></div></td><td style=\"width:80px; text-align:center;\"><div class=\"leftdata\"></div><div class=\"rightdata\"></div></td><td style=\"width:107px; text-align:center;\"><div class=\"leftdata\"></div><div class=\"rightdata\"></div></td></tr>";
				jQuery(\'#lines\'+currPage+\' tr:first\').before(res1);
				jQuery(\'#lines\'+currPage+\' tr:last\').after(res);
