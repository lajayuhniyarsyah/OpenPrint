		...
		<tbody>
			<tr>
				<td>
					<table class="ReportTable" border="1">
						...
						<?php
							...
							foreach ($array as $val) {
								echo '<tr>';
										echo '<td colspan="9">'.$val['partner_name'].'<br/>'.$val['street'].'</td>';
								echo '</tr>';
							 ...
							 echo '<tr class="bgdark">
									<td class="bgdark" colspan="4">Total</td>
					...
					<tr class="grandtotal">
					<th  class="grandtotal"  style="text-align:left;" colspan="4">Grand Total</th>
