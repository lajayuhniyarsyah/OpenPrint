	...
	jQuery.each(lines,function(key,line){
		...
		if(currPage){
			if (cektable < HeightTable){
				var footer ='.$footer.';
				var footertotal = "<tr class=lineTable><td colspan=3></td><td colspan=3>TOTAL AMOUNT</td><td align=right>'.app\components\NumericLib::indoStyle($subtotal,2,',','.').'</td></tr><tr class=lineTable><td colspan=3></td><td colspan=3>Discount</td><td align=right>'.app\components\NumericLib::indoStyle($diskon,2,',','.').'</td></tr class=lineTable><tr><td colspan=3></td><td colspan=3>PPN 10%</td><td align=right>'.app\components\NumericLib::indoStyle($model->amount_tax,2,',','.').'</td></tr><tr class=lineTable><td colspan=3></td><td colspan=3>GRAND TOTAL</td><td align=right>'.app\components\NumericLib::indoStyle(round($subtotal+$model->amount_tax),2,',','.').'</td></tr>";
